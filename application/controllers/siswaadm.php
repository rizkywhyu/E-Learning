...
class siswaadm extends CI_Controller
{
    ...
    {
        $siswaadm = $this->Siswa_model->get_all();

        $data = array(
            'siswaadm_data' => $siswaadm
        );
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('siswaadm/createaksi'),
	    'NIS' => set_value('NIS'),
	    'Nama' => set_value('Nama'),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('siswaadm/update_action'),
