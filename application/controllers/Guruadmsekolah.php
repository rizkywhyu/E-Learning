...
class Guruadmsekolah extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $guru = $this->Guru_model->getgurubysekolah($this->session->userdata('id'));
        ...
        $this->template->load('templatep','guruadm_list', $data);
        //$this->template->load('template','uu',$data);
        // $this->load->model('Guru_model');
        // $data['guru_data'] = $this->Guru_model->get_all_guru();
        // $this->template->load('templatep','guruadm_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->template->load('templatep','guruadm_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('Guruadmsekolah'));
        }
    }
    ...
    public function create() 
    {
        ...
        $data = array(
            'button' => 'Create',
            'action' => site_url('Guruadmsekolah/createaksi'),
      ...
      'idSklh' => set_value('idSklh'),
        ...
        $this->template->load('templatep','guruadm_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('Guruadmsekolah/update_action'),
  ...
  $this->form_validation->set_rules('idSklh', 'idSklh', 'trim|required|xss_clean');
        ...
        function valid_id($kodeguru)
    {
        if ($this->Guru_model->valid_id($kodeguru) == TRUE)
        {
            ...
            $this->form_validation->set_message('valid_id', "kode guru dengan $kodeguru sudah terdaftar");
            return FALSE;
        }
        else
        {           
