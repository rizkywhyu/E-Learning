        ...
        <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo base_url()."assets/"; ?>gambar/fotoprofile/profil_<?php echo $siswa->getNis()  ?>.jpg" class="img-circle" alt="User Image">

                <p>
                  <?php
                    echo $siswa->getNama();
                  ?>
                  <small>Sekolah : <?php echo $siswa->getSekolah() ?></small>
                  <small>Kelas : <?php echo $siswa->getKelas() ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
