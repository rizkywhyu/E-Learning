        ...
        <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo base_url()."assets/"; ?>gambar/fotoprofile/profil_<?php echo $guru->getKodeguru()  ?>.jpg" class="img-circle" alt="User Image">

                <p>
                  <?php
                    echo $guru->getNama();
                  ?>
                  <small>Sekolah : <?php echo $guru->getSekolah() ?></small>
                  <small>Email : <?php echo $guru->getEmail() ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
