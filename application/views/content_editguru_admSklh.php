...
<section class="content-header">
 ...
 <section class='content'>
        ...
        <tr><td>Kode Guru <?php echo form_error('kodeguru') ?></td>
            <td><input type="text" class="form-control" name="kodeguru" id="kodeguru" placeholder="kodeguru" value="<?php echo $kodedsn; ?>" / >
        </td>
      ...
      <tr><td>Sekolah <?php echo form_error('Fakultas') ?></td>
