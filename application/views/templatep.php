    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="<?php echo base_Url().'MenuAdmSekolah/index' ?>" class="logo">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="<?php echo base_Url().'cont_akun/Logout' ?>" >
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<?php echo base_url()?>template/dist/img/ini.png" class="img-circle" alt="User Image">
                        </div>
...
<!--                                <small class="label pull-right bg-red">3</small>-->
                        ...
                        <?php
                        $menu2 = $this->db->get_where('menu2', array('is_parent' => 0,'is_active'=>1));
                        foreach ($menu2->result() as $m) {
                            // chek ada sub menu
                            $submenu = $this->db->get_where('menu2',array('is_parent'=>$m->id,'is_active'=>1));
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2017 <a>Aplikasi Pembelajaran SMP dan SMA di Kabupaten Bandung</a>.</strong>
            </footer>
