...
<section class="content-header">
  ...
  <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <h3 class='box-title'>DAFTAR SISWA <?php echo anchor('cont_admsklh/Beranda22/','Create',array('class'=>'btn btn-danger btn-sm'));?></h3>
      ...
      <tbody>
            ...
            <td><?php echo $admSklh->NIS?></td>
            <td><?php echo $admSklh->Nama ?></td>
            <td><?php echo $admSklh->Sekolah ?></td>
            
            <td style="text-align:center" width="140px">
            <?php 
            echo anchor(site_url('Siswa/read/'.$admSklh->NIS),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-danger btn-sm')); 
            echo '  '; 
            echo anchor(site_url('Siswa/update/'.$admSklh->NIS),'<i class="fa fa-pencil-square-o"></i>',array('title'=>'edit','class'=>'btn btn-danger btn-sm')); 
            echo '  '; 
            echo anchor(site_url('Siswa/delete/'.$admSklh->NIS),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure to Delete ?\')"'); 
