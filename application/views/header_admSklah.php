        ...
        <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?php echo base_url()."assets/"; ?>gambar/fotoprofile/profil_<?php echo $dosen->getKodeDosen()  ?>.jpg" class="img-circle" alt="User Image">

                <!-- <p>
                  <?php
                    echo $dosen->getNama();
                  ?>
                  <small>Sekolah : <?php echo $admSekolah->getFakultas() ?></small>
                  <small>Email : <?php echo $dosen->getEmail() ?></small>
                </p> -->
              </li>
              <!-- Menu Body -->
              <li class="user-body">
