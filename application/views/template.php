                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<?php echo base_url()?>template/dist/img/ic_user.png" class="img-circle" alt="User Image">
                        </div>
...
<!--                                <small class="label pull-right bg-red">3</small>-->
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2017 <a>Aplikasi Pembelajaran SMP dan SMA di Kabupaten Bandung</a>
            </footer>
